	...
	<form action="/Site/Email" id="formulario" method="POST">
		<div class="cuadro">
			...
			<div class="display divs boton_enviar">
				<button class="div_submit centrar" id="boton_enviar" onclick="validar_form()" type="button">Enviar &nbsp;&nbsp;<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/white_sobre.png" style="width: 30px; height: 20px;"></button></div>
		</div>
		<div id="capa_float">
		</div>
	</form>
