...
class ESelect2 extends CInputWidget
{
    ...
    public function init()
    {
        $this->defaultOptions = array(
            'formatNoMatches' => 'js:function(){return "' . Yii::t('ESelect2.select2', 'No se encontraron coincidencias') . '";}',
            ...
            'formatLoadMore' => 'js:function(pageNumber){return "' . Yii::t('ESelect2.select2', '<h4><b>Obteniendo más resultados...</b></h4>') . '";}',
