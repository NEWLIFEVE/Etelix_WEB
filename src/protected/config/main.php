...
return array(
    ...
    'name'=>'Etelix Web',
    'timeZone'=>'America/Caracas', 'theme' => 'frontend',
/*theme is copied eg. from vendor/p3bootstrap*/
'language' => 'es',
/*default language, see also components.langHandler*/
'preload' =>
array('log',
'langHandler',
'bootstrap',
...
array(
	...
	'vendor.phundament.p3widgets.components.*',

	/*P3WidgetContainer, P3Reference Widget*/
	'vendor.phundament.p3extensions.components.*',

	/*shared classes*/
	'vendor.phundament.p3extensions.behaviors.*',

	/*shared classes*/
	'vendor.phundament.p3extensions.widgets.*',

	/*shared classes*/
	'vendor.phundament.p3extensions.helpers.*',

	/*shared classes - P3StringHelper*/
	'vendor.phundament.p3extensions.validators.*',

	/*shared classes - P3StringHelper*/
	'vendor.phundament.p3pages.models.*',

	/*Meta description and keywords (P3Media)*/
	'vendor.phundament.p3media.models.*',

	/*Meta description and keywords (P3Media)*/
	'vendor.phundament.p3extensions.widgets.ckeditor.*',

	/*shared classes*/
	'vendor.schmunk42.relation.widgets.*',

	/*Include For p3media for media meta update.*/
...
array(
	...
	array(
		...
		array(
			...
			array(
				...
				'IntroJs' => 'IntroJS'// use eg. $> php composer.phar require yiiext/swf-object-widget to get the
			...
			array(
				...
				array(
					...
					array(
						...
						/*use third parameter for master setting, see Image constants*/
	...
	array(
		...
		'userIdColumn' => 'id',
		'userClass' => 'User',
		'cssFile' => '/themes/backend/css/yii-rights.css'#'install' => true, // Enables the installer.
		#'superuserName' => 'admin'
	),
	'user' =>
	array(
...
array(
	...
	array(
		...
		/*whether to register any CSS at all, defaults to true*/
		'bootstrapCss' => false,

		/*use csutom css from theme*/
		'responsiveCss' => false,
	...
	array(
		...
		/*enable to activate component*/
		'combineOnly' => true,

		/*set to false on production systems*/
		'rewriteCssUris' => true,
		'blockedScripts' =>
		array(
	...
	array(
		...
		/*available languages, eg. 'lv', 'ru', 'fr'*/
	),
	'log' =>
	array(
		'class' => 'CLogRouter',
		...
		array(
			// Yii debug toolbar
			array('class' => 'vendor.malyshev.yii-debug-toolbar.YiiDebugToolbarRoute',
			'ipFilters' =>
			array('127.0.0.1'),
			'enabled' => true,
		),
...
array(
	...
	/*enable mod_rewrite in .htaccess if this is set to false*/
	'appendParams' => false,

	/*in general more error resistant*/
	'urlFormat' => 'path',

	/*use 'path', otherwise rules below won't work*/
	'rules' =>
	array(
		// backend
		...
		/*p3pages - SEO*/
		'<lang:[a-z]{2}(_[a-z]{2})?>/<pageName:[a-zA-Z0-9-._]*>-<pageId:\d+>' => 'p3pages/default/page',
...
array(
	...
	array(
		...
		'templates_files' =>
		array(
			$baseUrl.'/index.php?r=ckeditorConfigurator/default/cktemplates',
		),
		...
		'filebrowserBrowseCreateUrl' =>
		array(
			'/p3media/ckeditor',
		),
		'filebrowserImageBrowseCreateUrl' =>
		array(
			'/p3media/ckeditor/image',
		),
		'filebrowserFlashBrowseCreateUrl' =>
		array(
			'/p3media/ckeditor/flash',
		),
		'filebrowserUploadCreateUrl' =>
		array(
			'/p3media/import/ckeditorUpload',
		),
	),
	'ext.ckeditor.dtd' =>
	array(
