...
array(#'less', // LESS compiler, only preload on dev systems, config see below
),
'modules' =>
array(
	// code generator
...
array(
	...
	array(
		...
		array(
			...
			'findInPhpMessageSource',
		),

		/*Notice: degrades performance only enable on development systems*/
	),
	'less' =>
	array(
