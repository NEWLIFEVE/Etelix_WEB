...
class SiteController extends Controller
{
	...
	public function actionMensaje() 
	{
		...
		//print_r("correo: ".$correo. " mensaje: ".$mensaje);
		$correo_empresa="abelardotorres87@gmail.com";
		if(Yii::app()->mail->enviar($mensaje, $correo_empresa, 'Mensaje de contacto de la pag')){
			echo "ensaje enviado";
		}
		else{
			echo "error";
