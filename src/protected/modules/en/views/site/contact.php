		...
		<div class="cuadro">
			...
			<div class="display divs boton_enviar">
				<div class="erroress" id="mensaje6">
					<img alt="etelix" src="<?php echo Yii::app()->request->baseUrl; ?>/images/ajax-loader.gif" />Sending message
				</div>


				<button class="div_submit centrar" id="boton_enviar" type="button">Send &nbsp;&nbsp;<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/white_sobre.png" style="width: 30px; height: 20px;"></button></div>
