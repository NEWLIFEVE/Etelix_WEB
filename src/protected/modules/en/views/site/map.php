<div class="widget display" id="widget-26">
    <div align="center" class="map">
    	<div id="all_country_div">
				<div class="pais_1">
					<p class="pais_titulo">
						<a href="#" id="inglaterra"  title="Ver Dirección en Inglaterra">England</a>
					</p>
				...
				<div class="pais_2">
					<p class="pais_titulo">
						<a href="#" id="usa"  title="Ver Dirección en Estado Unidos">EEUU</a>
					</p>
					<p class="pais_capital">
				...
				<div class="pais_7">
					...
					<p class="pais_capital">
					<a href="#" id="peru"  title="Ver Dirección en Perú">Lima</a>
					</p>
				</div>
